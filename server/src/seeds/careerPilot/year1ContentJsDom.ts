...
staring at a dead button with no explanation of what is wrong. Let them submit, then tell them.`,
    ...
    checkpoint: [
      mcq('Why not disable the submit button until the form is valid?',
        [['The user is left with a dead button and no explanation of what is wrong', true],
          ['It is slower', false],
          ['It breaks validation', false],
          ['It is fine to do', false]],
        'Let them submit and then tell them, so the reason is visible rather than inferred.'),
