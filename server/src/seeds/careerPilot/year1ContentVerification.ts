...
it.`,
    checkpoint: [
      ...
      mcq('`(A AND B) OR (A AND NOT B)` simplifies to:',
        ...
        'A is true in both branches and B covers every possibility, so B decides nothing. Recognising this pattern is what stops a condition growing arms and legs.'),
