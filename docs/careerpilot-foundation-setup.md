...
3. publication of **exactly the certified 348 units**, through the product's publish handler and its
   gates, refused if the tenant's READY inventory is not identical to the certified one
4. verification: 359 units, 354 READY, PRODUCTION = the certified 348, quiz linkage, the stage skill
