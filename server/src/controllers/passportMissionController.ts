...
import { missionsForDay, dayNumber, ymd } from '../services/passportMissionService';
...
export const getToday = async (req: Request, res: Response) => {
  try {
    ...
    const missions = missionsForDay(attempt, day);
...
export const completeMission = async (req: Request, res: Response) => {
  try {
    ...
    const valid = missionsForDay(attempt, day).find(m => m.key === key);
