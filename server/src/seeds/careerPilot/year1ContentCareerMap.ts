...
are the actual Year-1 curriculum, which is why your foundation is not wasted whichever you pick.`,
    mcqs: [
      mcq('Which best describes what most of a working day involves, in every one of these roles?',
        [['Understanding the problem — typing is the short part', true],
          ['Writing new code from scratch', false],
          ['Attending meetings', false],
          ['Learning new frameworks', false]],
      ...
      mcq('A backend engineer adds a field to an API. What is the characteristic concern?',
        [['What happens to existing clients that do not know about the change', true],
          ['Whether the field name is short', false],
          ['Which colour it appears in', false],
          ['How fast it renders', false]],
      ...
      mcq('What do all five roles genuinely share?',
        [['Reading others\' code, version control, debugging and written explanation', true],
          ['The same programming language', false],
          ['The same working hours', false],
          ['A computer science degree', false]],
    ...
    checkpoint: [
      mcq('You are told a role is "full stack". What does that tell you about the Tuesday?',
        [['Little on its own — it spans both, and the balance differs completely between teams', true],
          ['They spend half the day on each', false],
          ['They are more senior', false],
          ['They do not write tests', false]],
      ...
      mcq('Which is the most reliable way to find out what a role involves?',
        [['Ask somebody doing it what they did last week', true],
          ['Read the job title', false],
          ['Read a job advert', false],
          ['Read a syllabus', false]],
...
weighing up.`,
    mcqs: [
      ...
      mcq('Why does the role-specific thirty per cent LOOK like the whole job?',
        [['It is what job adverts list and what people argue about publicly', true],
          ['It takes longer to learn', false],
          ['It is more important', false],
          ['It is harder', false]],
      ...
      mcq('Specialising before the core is secure typically produces:',
        [['Somebody who can use a framework and cannot debug it', true],
          ['A faster route to employment', false],
          ['A deeper specialist', false],
          ['No particular problem', false]],
    ...
    checkpoint: [
      mcq('You want to keep the most options open. Where is time best spent first?',
        [['The shared core, because every direction requires it', true],
          ['Two specialisms at once', false],
          ['Whichever specialism pays most', false],
          ['The newest technology', false]],
      ...
      mcq('An advert lists eight specific technologies. What does the shared-core picture suggest?',
        [['Most of the eight sit in the visible thirty per cent, and the core still matters more', true],
          ['You need all eight before applying', false],
          ['The role is unusually demanding', false],
          ['The advert is fake', false]],
    ...
    mcqs: [
      mcq('Where does a first-year engineer spend most of their time?',
        [['Building small well-specified changes and reviewing others\' code', true],
          ...
          ['Deciding what to build', false],
          ['Deploying to production', false]],
      ...
      mcq('Somebody requests changes on your pull request. What does that usually mean?',
        [['The normal mechanism by which faults are caught and knowledge spreads', true],
          ['Your work was poor', false],
          ['You are being tested', false],
          ['The change will be rejected', false]],
      ...
      mcq('Which bug report can actually be worked on?',
        [['"Clicking Save with an empty email shows a spinner forever"', true],
          ['"The form is broken"', false],
          ['"It does not work on my machine"', false],
          ['"Users are complaining"', false]],
      ...
      mcq('Automated tests run on every push mainly so that:',
        [['A change that breaks something does not proceed further', true],
          ['Developers write fewer bugs', false],
          ['Deployment is faster', false],
          ['Code review is unnecessary', false]],
    ...
    checkpoint: [
      mcq('You have been stuck on the same problem for two days. What does the team expect?',
        [['That you would have asked well before now', true],
          ['That you keep going alone', false],
          ['That you escalate to a manager', false],
          ['That you switch tasks', false]],
      ...
      mcq('Which step most often reveals the question nobody asked?',
        [['Specifying what should happen, including when things go wrong', true],
          ['Deployment', false],
          ['Estimation', false],
          ['Monitoring', false]],
...
shortlist is a compromise.`,
    mcqs: [
      mcq('A junior advert says "3+ years experience". The most likely explanation is:',
        [['It was copied from a template or is aspirational', true],
          ['They will not consider you', false],
          ['The role is mislabelled senior', false],
          ['They want a career changer', false]],
      ...
      mcq('Which capability is assessed more often than it is advertised?',
        [['Debugging a fault you did not write, methodically', true],
          ['Framework knowledge', false],
          ['Algorithm complexity', false],
          ['Typing speed', false]],
      ...
      mcq('The most useful portfolio piece is:',
        [['Something small you can explain completely, including what broke', true],
          ['The largest project you can build', false],
          ['A clone of a well-known app', false],
          ['Many small tutorial projects', false]],
    ...
    checkpoint: [
      mcq('You meet six of a role\'s ten listed requirements. What is the sensible action?',
        [['Apply — the advert is a wish list and the shortlist is a compromise', true],
          ['Wait until you meet all ten', false],
          ['Apply only if the six are the technical ones', false],
          ['Ask them to lower the requirements', false]],
...
it to avoid deciding forever.`,
    mcqs: [
      mcq('Switching direction after six months costs roughly:',
        [['The thirty per cent that was specific — the core transfers', true],
          ['All six months', false],
          ['Nothing at all', false],
          ['More than starting over', false]],
      ...
      mcq('Which is the strongest evidence that a direction suits you?',
        [['You enjoyed the actual work when you tried it, not the idea of it', true],
          ['It pays the most', false],
          ['It is currently in demand', false],
          ['Your friends chose it', false]],
      ...
      mcq('Why is refusing to choose anything a problem?',
        [['Depth in one area is what teaches you how to reach depth in another', true],
          ['You will fall behind peers', false],
          ['Employers dislike it', false],
      ...
      mcq('"Committing loosely" in practice means:',
        [['Going genuinely deep for a defined period, then reconsidering', true],
          ['Studying several directions at once', false],
          ['Choosing but not studying it', false],
          ['Waiting for more information', false]],
    ...
    checkpoint: [
      mcq('A student picks a direction because it currently pays most. What is the flaw?',
        [['Pay shifts over a career, and being poor at something you dislike is a worse position', true],
          ['Pay is irrelevant', false],
          ['It is not a flaw', false],
          ['They should pick the hardest instead', false]],
      ...
      mcq('A student genuinely cannot choose. What does the programme do?',
        [['Gives breadth across several directions rather than defaulting them into one', true],
          ['Assigns the most popular direction', false],
          ['Delays their plan', false],
          ['Gives only universal material', false]],
    ...
    mcqs: [
      mcq('Why compare three adverts for the same title rather than reading one closely?',
        [['What appears in all three is the job; the rest is that company', true],
          ['Three is more thorough', false],
          ['Adverts are often fake', false],
          ['To find the highest salary', false]],
      ...
      mcq('Why research what people DISLIKE about a role?',
        [['Every role has a downside, and you need to know whether it is one you can live with', true],
          ['To avoid the role', false],
          ['To ask about it at interview', false],
      ...
      mcq('Which source is more trustworthy?',
        [['Somebody describing a specific annoying Tuesday', true],
          ['A polished career-path article', false],
          ['A course provider\'s role guide', false],
          ['A salary comparison site', false]],
      ...
      mcq('You cannot write a sentence about what concerns you in the role. That means:',
        [['The research is not finished — every role has a downside', true],
          ['The role is a perfect fit', false],
          ['You should choose it', false],
          ['The sources were good', false]],
    ...
    checkpoint: [
      ...
      mcq('Your report should end with what?',
        [['What attracts you and what concerns you, in two sentences', true],
          ['A conclusion about which role is best', false],
          ['A list of courses to take', false],
          ['A salary estimate', false]],
