...
export const SPECIALIZE_MODULES: FoundationModuleSeed[] = [
  ...
  {
    moduleCode: 'S18B_SOFTWARE_ENGINEERING',
    moduleName: 'Software Engineering Specialization',
    displayOrder: 185,
    blurb: 'How software is built: design, quality, architecture and the workflow around them.',
    topics: [
      {
        topicCode: 'T3_SWE_DESIGN', title: 'Designing Before Building',
        skillKeys: ['SOFTWARE_ARCHITECTURE', 'DESIGN_PATTERNS'],
        category: 'DIRECTION', applicableDirections: ['SOFTWARE_ENGINEERING'], defaultDepth: 'CHALLENGE',
        learningOutcomes: [
          'Produce a design somebody else could build from, and say what it deliberately does not do.',
        ],
        prerequisiteSkillKeys: ['OOP_CONCEPTS', 'SYSTEM_DESIGN_BASICS'],
        backbone: true,
      },
      {
        topicCode: 'T3_SWE_QUALITY', title: 'Quality as Something You Build In',
        skillKeys: ['AUTOMATED_TESTING', 'CODE_REVIEW'],
        category: 'DIRECTION', applicableDirections: ['SOFTWARE_ENGINEERING'], defaultDepth: 'CHALLENGE',
        learningOutcomes: [
          'Choose the tests that would catch the failures this design invites.',
          'Review somebody else’s change so the defect gets fixed and they send you the next one.',
        ],
        prerequisiteSkillKeys: ['TESTING_FUNDAMENTALS', 'CLEAN_CODE'],
        backbone: true,
      },
      {
        topicCode: 'T3_SWE_EVOLVING', title: 'Changing Code You Did Not Write',
        skillKeys: ['REFACTORING', 'TECHNICAL_DEBT'],
        category: 'DIRECTION', applicableDirections: ['SOFTWARE_ENGINEERING'], defaultDepth: 'CHALLENGE',
        learningOutcomes: [
          'Make a safe change in an unfamiliar codebase, in steps that each stay green.',
          'Name what a shortcut will cost, and decide whether it is worth taking.',
        ],
        prerequisiteSkillKeys: ['CLEAN_CODE', 'DEBUGGING'],
        backbone: true,
      },
      {
        topicCode: 'T3_SWE_WORKFLOW', title: 'How a Team Actually Ships',
        skillKeys: ['CI_CD', 'GIT_BRANCHING'],
        category: 'DIRECTION', applicableDirections: ['SOFTWARE_ENGINEERING'], defaultDepth: 'CHALLENGE',
        learningOutcomes: ['Work in a branch-and-review workflow with a pipeline that does the shipping.'],
        prerequisiteSkillKeys: ['GIT_BRANCHING'],
      },
      {
        topicCode: 'T3_SWE_DOCS', title: 'Writing the Decisions Down',
        skillKeys: ['TECHNICAL_WRITING', 'LOGGING_DIAGNOSTICS'],
        category: 'DIRECTION', applicableDirections: ['SOFTWARE_ENGINEERING'], defaultDepth: 'CHALLENGE',
        learningOutcomes: ['Leave behind what the next engineer needs: why it is this way, and what it does at 3am.'],
        prerequisiteSkillKeys: ['TECHNICAL_COMMUNICATION'],
      },
      {
        topicCode: 'T3_SWE_PROJECT', title: 'Software Engineering Project',
        skillKeys: ['PRODUCTION_ENGINEERING', 'SOFTWARE_ARCHITECTURE'],
        category: 'DIRECTION', applicableDirections: ['SOFTWARE_ENGINEERING'], defaultDepth: 'CHALLENGE',
        learningOutcomes: ['Build one system designed, tested, reviewed and documented as a team would expect.'],
        prerequisiteSkillKeys: ['AUTOMATED_TESTING'],
        backbone: true,
      },
    ],
  },
  {
    moduleCode: 'S18C_FULL_STACK',
    moduleName: 'Full-Stack Engineering Specialization',
    displayOrder: 188,
    blurb: 'The whole application, and especially the seams where its halves meet.',
    topics: [
      {
        topicCode: 'T3_FS_BOUNDARY', title: 'The Seam Between Front and Back',
        skillKeys: ['API_DESIGN', 'STATE_MANAGEMENT'],
        category: 'DIRECTION', applicableDirections: ['FULL_STACK'], defaultDepth: 'CHALLENGE',
        learningOutcomes: [
          'Design the contract between an interface and its service so neither has to guess.',
          'Decide what the client keeps and what it asks for every time.',
        ],
        prerequisiteSkillKeys: ['REST_APIS', 'JS_ASYNC'],
        backbone: true,
      },
      {
        topicCode: 'T3_FS_AUTH', title: 'Auth Across the Whole Application',
        skillKeys: ['AUTHENTICATION', 'AUTHORIZATION'],
        category: 'DIRECTION', applicableDirections: ['FULL_STACK'], defaultDepth: 'CHALLENGE',
        learningOutcomes: [
          'Carry a login from a form, through a service, to a row, and check it at every step.',
          'Keep the client honest without trusting it.',
        ],
        prerequisiteSkillKeys: ['HTTP', 'SECURITY_FUNDAMENTALS'],
        backbone: true,
      },
      {
        topicCode: 'T3_FS_DATA', title: 'One Model, From Screen to Table',
        skillKeys: ['DB_DESIGN', 'DATA_WRANGLING'],
        category: 'DIRECTION', applicableDirections: ['FULL_STACK'], defaultDepth: 'CHALLENGE',
        learningOutcomes: ['Keep one idea coherent as it changes shape between the database and the screen.'],
        prerequisiteSkillKeys: ['DB_DESIGN', 'SQL_JOINS'],
        backbone: true,
      },
      {
        topicCode: 'T3_FS_QUALITY', title: 'Testing Something With Two Halves',
        skillKeys: ['AUTOMATED_TESTING', 'MONITORING_OBSERVABILITY'],
        category: 'DIRECTION', applicableDirections: ['FULL_STACK'], defaultDepth: 'CHALLENGE',
        learningOutcomes: ['Test each half alone and the seam between them, and know which failure each catches.'],
        prerequisiteSkillKeys: ['TESTING_FUNDAMENTALS'],
      },
      {
        topicCode: 'T3_FS_DEPLOY', title: 'Deploying the Whole Thing',
        skillKeys: ['DEPLOYMENT', 'CONTAINERS_DOCKER'],
        category: 'DIRECTION', applicableDirections: ['FULL_STACK'], defaultDepth: 'CHALLENGE',
        learningOutcomes: ['Ship an interface, a service and a database together, and roll all three back.'],
        prerequisiteSkillKeys: ['DEVOPS_FUNDAMENTALS'],
      },
      {
        topicCode: 'T3_FS_PROJECT', title: 'Full-Stack Project',
        skillKeys: ['PRODUCTION_ENGINEERING', 'API_DESIGN'],
        category: 'DIRECTION', applicableDirections: ['FULL_STACK'], defaultDepth: 'CHALLENGE',
        learningOutcomes: ['Ship one application end to end: interface, service, data, auth and deployment.'],
        prerequisiteSkillKeys: ['REST_APIS'],
        backbone: true,
      },
    ],
