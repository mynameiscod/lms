...
export const SETTING_DEFS: SettingDef[] = [
  ...
  // Per-purpose templates. Meta validates parameter count against the template you name, so
  // messages with different shapes cannot share one slot; each purpose points at its own
