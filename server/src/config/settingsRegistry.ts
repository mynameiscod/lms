...
export const SETTING_DEFS: SettingDef[] = [
  ...
  { key: 'PASSPORT_ENABLED', label: 'Career Passport — Platform Kill-switch', group: 'integrations', type: 'select', options: ['true', 'false'], help: 'Optional emergency OFF for the whole Career Passport product. Leave blank/true; set to false only to force it off globally. The real on/off is the Enable toggle inside the Career Passport → Config admin section.', perTenant: true },
